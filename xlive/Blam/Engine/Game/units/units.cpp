...
namespace units
{
	...
	{
		LOG_TRACE_GAME("unit_reset_equipment(unit_idx: %08X)", unit_idx);
	...
	{
		LOG_TRACE_GAME("unit_inventory_next_weapon(unit_idx: %08X)", unit_idx);
	...
	{
		LOG_TRACE_GAME("assign_equipment_to_unit(unit_idx: %08X,object_idx: %08X,a3: %08X)", unit_idx, object_idx, a3);
