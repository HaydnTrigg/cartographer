...
{
	typedef void(__thiscall* data_encode_integer_t)(bitstream*, const char*, unsigned int, signed int);
...
void bitstream::data_encode_signed_integer(const char* name, signed int value, unsigned int size_in_bits)
{
	typedef void(__thiscall* data_encode_signed_integer_t)(bitstream*, const char*, signed int, signed int);
...
signed int bitstream::data_decode_signed_integer(const char* name, unsigned int size_in_bits)
{
	typedef signed int(__thiscall* data_decode_signed_integer_def)(bitstream*, const char*, unsigned int);
